...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        # Open the last-used project folder, or fall back to the current directory
        start_dir = _settings.get("last_project_folder") or QDir.currentPath()
        if not os.path.isdir(start_dir):
            start_dir = QDir.currentPath()
        self.set_project_folder(start_dir)
